<script src="/admin-template/assets/js/core/jquery.3.2.1.min.js"></script>
<script src="/admin-template/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
